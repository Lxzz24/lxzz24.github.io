...
5. 抽象工厂模式的调用顺序示意图
  ...
  ![](assets/抽象工厂_抽象工厂模式的调用顺序示意图.jpg)
...
![](assets/抽象工厂_ DAO模式采用工厂方法模式来实现的策略.jpg)


### DAO 模式采用抽象工厂模式来实现的策略
![](assets/抽象工厂_ DAO模式采用抽象工厂模式来实现的策略.jpg)
