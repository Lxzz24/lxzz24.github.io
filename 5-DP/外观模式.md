...
###  生活中的示列：组装电脑
1. 完全自己组装
![](assets/外观模式组装电脑_完全自己组装.jpg)

2. 找专业装机公司组装
![](assets/外观模式组装电脑_找专业公司组装.jpg)

###  工具示例：代码生成工具
![](assets/外观模式组装电脑_代码生成工具.jpg)

`问题：`如果现在客户端需要使用这个代码生成工具来生成需要的基础代码，该如何来实现呢？

###  不用模式解决方案

![](assets/外观模式_不用模式解决方案.jpg)

`存在的问题：`客户端为了使用生成代码的功能，需要与生成代码子系统内部的多个模块交互

### 使用模式解决方案
![](assets/外观模式_用模式解决方案.jpg)
...
5. 外观模式的调用顺序示意图
![](assets/外观模式_调用顺序示意.jpg)

### 外观模式的实现
1. 把外观类当成一个辅助工具类实现
2. facade可以实现为interface
![](assets/外观模式_实现facade实现为interface.jpg)
