...
![](assets/工厂方法_客户端使用由Creator创建出来的对象情况的调用示意图.png)

![](assets/工厂方法_客户端使用Creator对象时候的调用顺序示意图.png)
...
![](assets/工厂方法_ioc主动创建.jpg)

**有了IOc/DI的时候，A类不再主动去创建C了**

![](assets/工厂方法_不主动创建.jpg)
