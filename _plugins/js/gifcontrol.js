!(function (t) {
      ...
      c = function (t, n, r) {
        ...
        for (s in (v && (r = n), r))
          (l = ((f = !p && m && void 0 !== m[s]) ? m : r)[s]),
            (h = y && f ? u(l, e) : g && "function" == typeof l ? u(Function.call, l) : l),
            m && a(m, s, l, t & c.U),
            w[s] != l && i(w, s, h),
            g && x[s] != l && (x[s] = l);
      };
  ...
  function (t, n, r) {
    ...
    (h && p) ||
      ...
      "process" == r(11)(l)
        ...
        : v
        ? ((i = (o = new v()).port2), (o.port1.onmessage = w), (e = a(i.postMessage, i, 1)))
    ...
    if (r(5)) {
      var e = r(16),
        ...
        Lt = function (t) {
          ...
          for (
            l && c > 2 && (f = s(f, arguments[2], 2)), n = 0, r = d(u.length), o = It(this, r);
            r > n;
            n++
          )
            o[n] = l ? f(u[n], n) : u[n];
      ...
      mt || ((U.f = Wt), (W.f = Ut)),
        a(a.S + a.F * !mt, "Object", { getOwnPropertyDescriptor: Wt, defineProperty: Ut }),
        i(function () {
          ht.call({});
        }) &&
          (ht = pt =
          ...
          w
            ? ((v = r(function (t, r, e, o) {
                ...
                var i,
                  ...
                  p = 0;
                if (b(r)) {
                  if (!(r instanceof Y || "ArrayBuffer" == (c = x(r)) || "SharedArrayBuffer" == c))
                ...
                for (h(t, "_d", { b: i, o: p, l: a, e: u, v: new q(i) }); l < u; ) O(t, l++);
              })),
              (E = v.prototype = k(Dt)),
              h(E, "constructor", v))
            : (i(function () {
              ...
              ((v = r(function (t, r, e, o) {
                ...
                return (
                  f(t, v, s),
                  b(r)
                    ? r instanceof Y || "ArrayBuffer" == (i = x(r)) || "SharedArrayBuffer" == i
                      ? void 0 !== o
                        ? new y(r, kt(e, n), o)
                        : void 0 !== e
                        ? new y(r, kt(e, n))
  ...
  function (t, n, r) {
    for (
      ...
      (e = o[h[l++]]) ? (i(e.prototype, u, !0), i(e.prototype, c, !0)) : (f = !1);
    ...
    function e(t, n, r, e) {
      for (
        ...
        if (((l >>= c), (f -= c), g !== i)) {
          ...
          null !== d &&
            u < 4096 &&
            ((v[u++] = (d << 8) | x), u >= s + 1 && c < 12 && (++c, (s = (s << 1) | 1))),
            (d = g);
      ...
      (n.GifWriter = function (t, n, r, e) {
        ...
        (this.addFrame = function (n, r, e, i, c, s) {
          ...
          return (o = (function (t, n, r, e) {
            ...
            function h(r) {
              for (; f >= r; )
                (t[n++] = 255 & l), (l >>= 8), (f -= 8), n === o + 256 && ((t[o] = 255), (o = n++));
            }
            function p(t) {
              (l |= t << f), (f += s), h(8);
            }
            ...
            return (
              p(v), p(u), h(1), o + 1 === n ? (t[o] = 0) : ((t[o] = n - o - 1), (t[n++] = 0)), n
            );
          })(t, o, p < 2 ? 2 : p, c));
        }),
          (this.end = function () {
        ...
        (v =
          ...
          "".split(/.?/).length
            ? function (t, n) {
                ...
                return (
                  l === o.length ? (!u && v.test("")) || c.push("") : c.push(o.slice(l)),
        ...
        [
          ...
          function (t, n) {
            ...
            for (var x = 0, b = 0, _ = []; b < h.length; ) {
              ...
              var E,
                k = c(m, p ? h : h.slice(b));
              if (null === k || (E = l(u(m.lastIndex + (p ? 0 : b)), h.length)) === x)
                b = a(h, b, g);
              else {
      ...
      return [
        ...
        function (t, n) {
          ...
          for (var x, b = "", _ = 0, E = 0; E < m.length; E++) {
            w = m[E];
            for (
              var k = String(w[0]), S = s(f(a(w.index), h.length), 0), I = [], O = 1;
              O < w.length;
              O++
            )
      ...
      r(9)(function () {
        ...
        ? function (t, n) {
            for (var r = u(t), s = arguments.length, f = 1, l = i.f, h = a.f; s > f; )
              for (
                var p, v = c(arguments[f++]), d = l ? o(v).concat(l(v)) : o(v), g = d.length, y = 0;
                g > y;
    ...
    function C(t, n, r) {
      ...
      for (
        (t = I(t)) != t || t === k
          ...
          : ((e = j(A(t) / L)),
            t * (i = O(2, -e)) < 1 && (e--, (i *= 2)),
            (t += e + s >= 1 ? f / i : f * O(2, 1 - s)) * i >= 2 && (e++, (i /= 2)),
            e + s >= c
              ? ((o = 0), (e = c))
              : e + s >= 1
              ? ((o = (t * i - 1) * O(2, n)), (e += s))
  ...
  function (t, n, r) {
    ...
    t.exports = function (t, n, r, v, d, g, y) {
      ...
      if (
        ...
        if (((m = { values: E ? O : b("values"), keys: g ? O : b("keys"), entries: j }), y))
      ...
      function k(t, r) {
        ...
        if (e === n) {
          if (((r.delegate = null), "throw" === r.method)) {
            if (
              t.iterator.return &&
              ((r.method = "return"), (r.arg = n), k(t, r), "throw" === r.method)
            )
              return v;
            (r.method = "throw"),
      ...
      function t(n) {
        ...
        !(function (t, n) {
          ...
          (this.frames = (function (t, n) {
            ...
            return function () {
              r = [];
              for (var n = 0, e = t.numFrames(); 0 <= e ? n < e : n > e; 0 <= e ? n++ : n--)
                r.push(n);
              return r;
            }
              .apply(this)
              .map(function (n) {
                var r;
                return (
                  ((r = t.frameInfo(n)).pixels = new Uint8ClampedArray(t.width * t.height * 4)),
          ...
          },
          {
            ...
            value: function () {
              ...
              return (
                ...
                null != (n = this.onFrame) && n.apply(this, [t, this.frameIndex]),
                      ...
                      for (;;)
                        switch ((t.prev = t.next)) {
                          ...
                          case 5:
                            return (
                              (o = t.sent),
                              (this.animator = new i(new e.GifReader(new Uint8Array(o)))),
